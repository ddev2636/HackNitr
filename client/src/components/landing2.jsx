    ...
    <div className='text-white w-[100vw] h-[100vh]'>
      ...
      <div className='l3 flex flex-row text-center'>
          <div className='l31 flex flex-col'>
              ...
              <button className="bg-red-600 hover:bg-red-300 ml-36 text-white font-semibold hover:text-white py-2 w-80 mt-7 hover:border-transparent rounded">Register as a Startup</button>
          ...
          <h1 className='text-3xl pb-5 font-semibold'>For Investors</h1>
              ...
              <button className="bg-blue-900 hover:bg-blue-300  text-white font-semibold hover:text-white py-2 w-80  mt-7 hover:border-transparent rounded">Register as a Startup</button>
              <p className='underline pt-10'>Learn More</p>
              </div>
          </div>
      </div>
